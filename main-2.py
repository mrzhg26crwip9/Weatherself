...
# ---------------------------------------------------------------------------
def build_report(open_meteo, aqi, wttr, weatherapi, met_norway) -> str:
...
async def send_daily_report(app: Client):
    ...
    async with aiohttp.ClientSession() as session:
        open_meteo, aqi, wttr, weatherapi, met_norway = await asyncio.gather(
    ...
    report_text = build_report(open_meteo, aqi, wttr, weatherapi, met_norway)
